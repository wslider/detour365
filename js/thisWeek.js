...
import { bcv_parser } from 'https://cdn.jsdelivr.net/npm/bible-passage-reference-parser@3.2.0/esm/bcv_parser.js';
import * as enLang from 'https://cdn.jsdelivr.net/npm/bible-passage-reference-parser@3.2.0/esm/lang/en.js';
...
export async function displayThisWeek() {
    try {
        ...
        if (episode.passage) {
            ...
            if (!osis || osis == "") {
                epFullPassage.textContent = '(Invalid passage reference)';
                return;
            }
